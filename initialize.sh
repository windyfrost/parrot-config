...
apt-get install -y zsh figlet toilet python3 python3-pip seclists dnsrecon enum4linux feroxbuster impacket-scripts redis-tools snmpwalk tnscmd10g wkhtmltopdf
